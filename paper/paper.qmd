...
final_results_baseline <- bind_rows(results, .id = "candidate")

# View the final results
kable(final_results_baseline)
...
intercept_wide_baseline <- intercept_results %>%
...
intercept_wide_baseline <- intercept_wide %>%
